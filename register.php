...
>Ph.D</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    class="form-control required" id="dateOfBirth" 
    ...
    echo 'selected';
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <input name="email" type="text" class="form-control unique" 
    ...
    echo 'checked';
                ...
                </div> <!-- end of the right portion of the basci information -->
            </div> <!-- end of basic information row -->
