...
$tableColumns = array( 'id', 'userName', 'firstName', 'middleName', 'lastName', 'suffix', 
...
$query = mysqli_query($connection, "SELECT id, userName, firstName, middleName, lastName, 
    suffix, gender, dateOfBirth, maritalStatus, employmentStatus, employer, email, 
    ...
    while ($record = mysqli_fetch_assoc($query)) {
        ...
        for ( $i = 0; $i < $numberOfColumns; $i++ )
        {
            if (0 == $i || 1 == $i) {
                ...
                $input = "<select name='suffix' class='invisibleBox' id='suffix'>" .
