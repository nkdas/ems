...
// this variable acts as a flag to determine if user employee_details are retrieved successfully from the database
...
<body>
    ...
    <div id="section1" class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-2">
                <img id="profilePhoto" src="images/<?php if ($row['photo']) { echo $row['photo']; } 
